...
console.log(utils.tokenize('Blu Oltre Mare 50 % di'));
let R = utils.getRandomInt(0, 255);
let G = utils.getRandomInt(0, 255);
let B = utils.getRandomInt(0, 255);
console.log(utils.rgb2hex(R,G,B));
console.log(utils.name2hex('Azzurro',ColorMatrix));
let color_hex = utils.hex();
console.log(color_hex);
console.log(utils.name(color_hex));
...
color_name = utils.name(color_hex);
console.log(color_name[1])
