...
const languageStrings = {
    'it-IT': {
        translation: {
            ...
            ADD_SUCCESS: 'Ok, il colore %s è stato aggiunto! Puoi cancellarlo dicendo: Alexa, Chiedi a '+skill_name+' rimuovi il colore %s',
            ADD_FAIL: 'Il colore %s è già in lista! Puoi sapere quali colori sono in lista dicendo: Alexa, Chiedi a '+skill_name+' quali sono i miei colori preferiti',
